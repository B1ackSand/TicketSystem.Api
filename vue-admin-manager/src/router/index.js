...
export const constantRoutes = [
    ...
    children: [
      {
        path: 'index',
        name: 'Booker',
        component: () => import('@/views/booker/index'),
    ...
    children: [
      {
        ...
        meta: { title: '停靠站详情', icon: 'dashboard' }
      }
    ]
  },
...

  {
    ...
    children: [
      {
        path: 'https://github.com/B1ackSand/Routine',
        meta: { title: 'Github链接', icon: 'link' }
      }
    ]
  },
